...
const Login = () => {
    ...
    return (
        <>
            <div className="bg-homeBg h-screen w-full">
                <div className="relative pt-36">

                    <div className="z-20 p-4 origin-bottom-right transform  border-4 border-red-400 lg:mx-56 h-full mx-8 rounded-2xl">
                        <div className="p-4 space-y-10 md:space-y-0 md:grid md:grid-cols-2">
                            ...
                            <div className="md:flex md:flex-col md:justify-center lg:pr-16">
                                ...
                                <h2 className="self-center mb-4 text-5xl font-bold tracking-wider text-red-400 font-carattere md:text-4xl lg:text-7xl">
                                    Welcome
                                </h2>
                                ...
                                <div className="relative mt-4 font-sourceSerifPro outline ">
                                    ...
                                    <label className="absolute top-0 p-2 pb-4 text-lg text-gray-500 duration-300 bg-homeBg md:text-lg -z-1 origin-0">Email</label>
                                </div>
                                ...
                                <div className="relative mt-8 font-sourceSerifPro outline ">
                                    ...
                                    <label className="absolute top-0 p-2 text-lg text-gray-500 duration-300 bg-homeBg md:text-lg -z-1 origin-0">Password</label>
                                </div>

                                <div className="grid justify-center grid-cols-1 gap-1 md:gap-4 mx-4 md:grid-cols-2">

                                    <button onClick={signIn} className="h-12 px-8 text-base font-semibold tracking-wider text-white border rounded-full shadow-sm font-fontVollkorn my-6 bg-red-400 hover:shadow-lg">Sign In</button>

                                    <button onClick={createAccount} className="h-12 px-8 text-base font-semibold tracking-wider text-red-400  rounded-full shadow-sm border-2 border-red-400 font-fontVollkorn my-6 hover:shadow-lg">Sign Up</button>
                                </div>

                                <div className="w-full flex items-center justify-center text-lg mb-4">
                                    <div className="inline-flex h-1 mx-4 bg-red-400 rounded-full w-52"></div>
                                    or
                                    <div className="inline-flex h-1 mx-4 bg-red-400 rounded-full w-52"></div>
                                </div>
